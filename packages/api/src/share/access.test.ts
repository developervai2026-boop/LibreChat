...
import { resolveShareAccess } from './access';
...
describe('resolveShareAccess', () => {
  ...
  describe('public links', () => {
    test('allows anonymous access when ALLOW_SHARED_LINKS_PUBLIC is true', async () => {
    ...
    test('allows authenticated access to public link even without ALLOW_SHARED_LINKS_PUBLIC', async () => {
      const link = await createTestLink();
      await grantPublicViewer(link._id);
  ...
  describe('private links', () => {
    ...
    test('allows authenticated user with ACL entry', async () => {
      const link = await createTestLink();
  ...
  describe('legacy link auto-migration', () => {
    ...
    test('auto-migrates public legacy link and grants access', async () => {
